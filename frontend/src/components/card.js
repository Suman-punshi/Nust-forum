...
export const Card = () => {
  ...
  const handleToggleCommunitySidebar = () => {
    setShowCommunitySidebar(!showCommunitySidebar);
  };

  return (
    <div>
      <Navbar onToggleSidebar={handleToggleSidebar} onToggleCommunitySidebar={handleToggleCommunitySidebar} />
    <div className="d-flex justify-content-center mt-5" style={{ marginTop: "80px", overflowX: 'hidden' }}>
      <div className="row">
        <div className="col-12 mb-3 d-flex justify-content-between">
          <button className="btn btn-primary" onClick={() => setShowSidebar(!showSidebar)}>
            Toggle Sidebar
          </button>
          <button className="btn btn-primary" onClick={() => setShowCommunitySidebar(!showCommunitySidebar)}>
            Toggle Community Sidebar
          </button>
        </div>
        {showSidebar && (
          <div className="col-lg-3">
        ...
        <div className={`col-lg-${showSidebar && showCommunitySidebar ? '6' : '12'}`}>
          <div className="container mt-5">
            <div className="row">
              <div className="col-12 mb-3">
                <h3 style={{ color: "#041e3d" }}>
        ...
        {showCommunitySidebar && (
          <div className="col-lg-3">
            <CommunitySidebar id={userId} className="community-sidebar" />
          </div>
        )}
      </div>
    </div>
