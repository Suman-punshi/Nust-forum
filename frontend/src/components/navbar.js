    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" style={{ backgroundColor: '#4D869C' }}>
            <div className="container-fluid">
                <Link className="navbar-brand" to="/">NUST Forums</Link>
                ...
                <div className="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                    ...
                    <ul className="navbar-nav ms-auto">
                        {user ? (
                            ...
                            <>
                                <li><Link to="/" className="btn btn-light me-2">Login</Link></li>
                                <li><Link to="/create-user" className="btn btn-light">Sign Up</Link></li>
                            </>
                        )}
                    </ul>
                </div>
